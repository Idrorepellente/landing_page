...
// Voci del sito mostrate direttamente nell'header (Runner e Messaggi stanno nel profilo).
...
// Non renderizza l'HTML della landing (quello arriva dal server): avvia solo i
// comportamenti e collega la navigazione del sito. Bundle client minimo.
export function LandingClient() {
  ...
  useEffect(() => {
    ...
    // avvia SEMPRE i comportamenti per primi (se il wiring nav fallisse, la pagina vive lo stesso)

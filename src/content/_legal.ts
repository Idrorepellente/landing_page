...
export const HEADER = `<header data-nav="" style="position: fixed;top: 0;left: 0;right: 0;z-index: 50;transition: transform .3s ease,box-shadow .3s ease,background .3s ease;background: rgba(255,255,255,.8);backdrop-filter: blur(12px);-webkit-backdrop-filter: blur(12px)">
...
/* ===== PAGINE LEGALI ===== */
.lg-wrap{max-width:840px;margin:0 auto;padding:132px 24px 76px;position:relative;z-index:1}
.lg-eyebrow{display:inline-block;font:600 11.5px/1 'IBM Plex Mono',monospace;letter-spacing:.14em;text-transform:uppercase;color:#5B57D9;background:#EEEDFB;padding:6px 12px;border-radius:999px;margin:0}
.lg-title{font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:40px;line-height:1.1;letter-spacing:-.02em;color:#18181b;margin:18px 0 0}
.lg-updated{font:500 13px 'IBM Plex Mono',monospace;color:#71717a;margin:12px 0 0}
.lg-intro{color:#3f3f46;font-size:16px;line-height:1.75;margin:22px 0 0}
.lg-toc{background:#fff;border:1px solid rgba(24,24,27,.08);border-radius:14px;padding:16px 20px;margin:28px 0 8px}
.lg-toc-t{font:700 12px 'IBM Plex Mono',monospace;letter-spacing:.08em;text-transform:uppercase;color:#71717a;margin:0 0 8px}
.lg-toc a{color:#3f3f46;font-size:13.5px;line-height:1.95;text-decoration:none;display:block}
.lg-toc a:hover{color:#5B57D9}
.lg-sec{margin:36px 0 0;scroll-margin-top:88px}
.lg-h2{font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:20px;line-height:1.3;color:#18181b;margin:0 0 10px}
.lg-p{color:#3f3f46;font-size:15px;line-height:1.75;margin:0 0 10px}
.lg-ul{margin:0 0 10px;padding-left:22px}
.lg-ul li{color:#3f3f46;font-size:15px;line-height:1.7;margin:0 0 6px}
.lg-p b,.lg-ul b{color:#18181b}
.lg-note{background:#fff;border:1px solid rgba(24,24,27,.1);border-left:3px solid #E0A83A;border-radius:12px;padding:16px 18px;margin:26px 0 0}
.lg-note p{margin:0;color:#3f3f46;font-size:14px;line-height:1.65}
.lg-note b{color:#18181b}
.lg-tbl{width:100%;border-collapse:collapse;margin:6px 0 10px;font-size:13.5px}
.lg-tbl th,.lg-tbl td{border:1px solid rgba(24,24,27,.1);padding:8px 10px;text-align:left;color:#3f3f46;vertical-align:top}
.lg-tbl th{background:#f4f4f5;color:#18181b;font-weight:700}
/* dark overrides (le classi non sono coperte da DARK_CSS che agisce sugli style inline) */
[data-theme="dark"] .lg-toc{background:#1c1c1f;border-color:rgba(255,255,255,.08)}
[data-theme="dark"] .lg-note{background:#1c1c1f;border-color:rgba(255,255,255,.1);border-left-color:#E0A83A}
[data-theme="dark"] .lg-title,[data-theme="dark"] .lg-h2,[data-theme="dark"] .lg-p b,[data-theme="dark"] .lg-ul b,[data-theme="dark"] .lg-note b{color:#ededf0}
[data-theme="dark"] .lg-intro,[data-theme="dark"] .lg-p,[data-theme="dark"] .lg-ul li,[data-theme="dark"] .lg-note p{color:#c7c7cc}
[data-theme="dark"] .lg-eyebrow{background:rgba(91,87,217,.18);color:#b9b7f4}
[data-theme="dark"] .lg-tbl th{background:#242428;color:#ededf0}
[data-theme="dark"] .lg-tbl th,[data-theme="dark"] .lg-tbl td{border-color:rgba(255,255,255,.12);color:#c7c7cc}
@media(max-width:640px){.lg-title{font-size:32px}.lg-wrap{padding:112px 18px 56px}}
`;

export function legalPage(title: string, updated: string, intro: string, toc: string, body: string): string {
  return `

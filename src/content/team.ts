...
<section id="top" style="max-width: 1152px;margin: 0 auto;padding: 128px 32px 10px;text-align: center">
  <div data-reveal="" style="opacity: 0;transform: translateY(28px);transition: opacity .7s cubic-bezier(.16,1,.3,1),transform .7s cubic-bezier(.16,1,.3,1)">
    <span style="display: inline-flex;align-items: center;gap: 6px;border-radius: 999px;padding: 5px 12px;font: 600 11.5px/1 'IBM Plex Mono',monospace;letter-spacing: .12em;text-transform: uppercase;white-space: nowrap;background: #EEEDFB;color: #5B57D9">IL TEAM</span>
    <h1 style="font-family: 'Space Grotesk',sans-serif;font-weight: 700;font-size: 44px;line-height: 1.08;letter-spacing: -.02em;margin: 18px 0 0;color: #18181b">Quattro fondatori, <span style="background: linear-gradient(100deg,#18181b,#5B57D9);-webkit-background-clip: text;background-clip: text;color: transparent">un metodo</span></h1>
    <p style="color: #6b7280;font-size: 16px;line-height: 1.6;margin: 16px auto 0;max-width: 540px">Un team compatto che copre l'intero ciclo: ricerca quantitativa, engineering, prodotto e community — con lo stesso rigore che vendiamo.</p>
  </div>
</section>
<!-- ============ MEMBRI ============ -->
<section style="max-width: 1152px;margin: 0 auto;padding: 36px 32px 8px">
  <div data-mscroll="" style="display: grid;grid-template-columns: repeat(4,1fr);gap: 16px">
    
    <div data-reveal="" data-reveal-d="0" style="background: #fff;border: 1px solid rgba(24,24,27,.07);border-radius: 20px;box-shadow: 0 1px 2px rgba(24,24,27,.04),0 14px 34px -22px rgba(24,24,27,.22);padding: 24px;text-align: center;opacity: 0;transform: translateY(28px);transition: opacity .7s cubic-bezier(.16,1,.3,1),transform .7s cubic-bezier(.16,1,.3,1)">
      <img src="https://i.pravatar.cc/160?img=12" style="height: 84px;width: 84px;border-radius: 999px;object-fit: cover;border: 3px solid #fff;box-shadow: 0 0 0 3px rgba(24,24,27,.06),0 16px 34px -16px rgba(24,24,27,.4)" alt="">
      <h3 style="font-family: 'Space Grotesk',sans-serif;font-weight: 700;font-size: 17px;margin: 14px 0 0;color: #18181b">Quant &amp; Research</h3>
      <p style="color: #6b7280;font-size: 13px;line-height: 1.6;margin: 8px 0 0">Le 29 strategie della libreria, il motore di validazione walk-forward e i sei gate di regime.</p>
      <div style="display: flex;justify-content: center;gap: 6px;flex-wrap: wrap;margin-top: 14px"><span style="display: inline-flex;padding: 5px 10px;border-radius: 999px;background: #f4f4f5;font: 600 10.5px 'IBM Plex Mono',monospace;color: #52525b">walk-forward</span><span style="display: inline-flex;padding: 5px 10px;border-radius: 999px;background: #f4f4f5;font: 600 10.5px 'IBM Plex Mono',monospace;color: #52525b">factor models</span></div>
    </div>
    
    <div data-reveal="" data-reveal-d="80" style="background: #fff;border: 1px solid rgba(24,24,27,.07);border-radius: 20px;box-shadow: 0 1px 2px rgba(24,24,27,.04),0 14px 34px -22px rgba(24,24,27,.22);padding: 24px;text-align: center;opacity: 0;transform: translateY(28px);transition: opacity .7s cubic-bezier(.16,1,.3,1),transform .7s cubic-bezier(.16,1,.3,1)">
      <img src="https://i.pravatar.cc/160?img=45" style="height: 84px;width: 84px;border-radius: 999px;object-fit: cover;border: 3px solid #fff;box-shadow: 0 0 0 3px rgba(24,24,27,.06),0 16px 34px -16px rgba(24,24,27,.4)" alt="">
      <h3 style="font-family: 'Space Grotesk',sans-serif;font-weight: 700;font-size: 17px;margin: 14px 0 0;color: #18181b">Engineering</h3>
      <p style="color: #6b7280;font-size: 13px;line-height: 1.6;margin: 8px 0 0">Architettura local-first, connettori Interactive Brokers e MetaTrader 5, parità research→live.</p>
      <div style="display: flex;justify-content: center;gap: 6px;flex-wrap: wrap;margin-top: 14px"><span style="display: inline-flex;padding: 5px 10px;border-radius: 999px;background: #f4f4f5;font: 600 10.5px 'IBM Plex Mono',monospace;color: #52525b">python</span><span style="display: inline-flex;padding: 5px 10px;border-radius: 999px;background: #f4f4f5;font: 600 10.5px 'IBM Plex Mono',monospace;color: #52525b">infra locale</span></div>
    </div>
    
    <div data-reveal="" data-reveal-d="160" style="background: #fff;border: 1px solid rgba(24,24,27,.07);border-radius: 20px;box-shadow: 0 1px 2px rgba(24,24,27,.04),0 14px 34px -22px rgba(24,24,27,.22);padding: 24px;text-align: center;opacity: 0;transform: translateY(28px);transition: opacity .7s cubic-bezier(.16,1,.3,1),transform .7s cubic-bezier(.16,1,.3,1)">
      <img src="https://i.pravatar.cc/160?img=33" style="height: 84px;width: 84px;border-radius: 999px;object-fit: cover;border: 3px solid #fff;box-shadow: 0 0 0 3px rgba(24,24,27,.06),0 16px 34px -16px rgba(24,24,27,.4)" alt="">
      <h3 style="font-family: 'Space Grotesk',sans-serif;font-weight: 700;font-size: 17px;margin: 14px 0 0;color: #18181b">Prodotto &amp; Design</h3>
      <p style="color: #6b7280;font-size: 13px;line-height: 1.6;margin: 8px 0 0">Dal walk-forward obbligatorio al blueprint builder no-code: il rigore reso semplice.</p>
      <div style="display: flex;justify-content: center;gap: 6px;flex-wrap: wrap;margin-top: 14px"><span style="display: inline-flex;padding: 5px 10px;border-radius: 999px;background: #f4f4f5;font: 600 10.5px 'IBM Plex Mono',monospace;color: #52525b">UX</span><span style="display: inline-flex;padding: 5px 10px;border-radius: 999px;background: #f4f4f5;font: 600 10.5px 'IBM Plex Mono',monospace;color: #52525b">no-code</span></div>
    </div>
    
    <div data-reveal="" data-reveal-d="240" style="background: #fff;border: 1px solid rgba(24,24,27,.07);border-radius: 20px;box-shadow: 0 1px 2px rgba(24,24,27,.04),0 14px 34px -22px rgba(24,24,27,.22);padding: 24px;text-align: center;opacity: 0;transform: translateY(28px);transition: opacity .7s cubic-bezier(.16,1,.3,1),transform .7s cubic-bezier(.16,1,.3,1)">
      <img src="https://i.pravatar.cc/160?img=52" style="height: 84px;width: 84px;border-radius: 999px;object-fit: cover;border: 3px solid #fff;box-shadow: 0 0 0 3px rgba(24,24,27,.06),0 16px 34px -16px rgba(24,24,27,.4)" alt="">
      <h3 style="font-family: 'Space Grotesk',sans-serif;font-weight: 700;font-size: 17px;margin: 14px 0 0;color: #18181b">Business &amp; Community</h3>
      <p style="color: #6b7280;font-size: 13px;line-height: 1.6;margin: 8px 0 0">Contest, marketplace, partner regolamentati e la rotta verso il fondo collettivo.</p>
      <div style="display: flex;justify-content: center;gap: 6px;flex-wrap: wrap;margin-top: 14px"><span style="display: inline-flex;padding: 5px 10px;border-radius: 999px;background: #f4f4f5;font: 600 10.5px 'IBM Plex Mono',monospace;color: #52525b">legal-first</span><span style="display: inline-flex;padding: 5px 10px;border-radius: 999px;background: #f4f4f5;font: 600 10.5px 'IBM Plex Mono',monospace;color: #52525b">community</span></div>
    </div>
  </div>
  <p style="text-align: center;color: #a1a1aa;font-size: 12.5px;margin: 22px 0 0">Volti e bio complete arrivano con la beta pubblica.</p>
</section>
<!-- ============ VALORI ============ -->
<section style="max-width: 900px;margin: 0 auto;padding: 40px 32px 48px">
  <div data-reveal="" style="border-radius: 16px;background: #fff;border: 1px solid rgba(24,24,27,.07);box-shadow: 0 1px 2px rgba(24,24,27,.04),0 12px 30px -20px rgba(24,24,27,.2);padding: 20px 24px;display: flex;flex-wrap: wrap;align-items: center;justify-content: center;gap: 10px 26px;opacity: 0;transform: translateY(28px);transition: opacity .7s cubic-bezier(.16,1,.3,1),transform .7s cubic-bezier(.16,1,.3,1)">
    <span style="font: 600 10.5px 'IBM Plex Mono',monospace;letter-spacing: .14em;text-transform: uppercase;color: #a1a1aa">I nostri principi</span>
    <span style="font: 600 13px Mulish,sans-serif;color: #3f3f46">Vendiamo rigore, non promesse</span><span style="height: 14px;width: 1px;background: rgba(24,24,27,.12)"></span>
    <span style="font: 600 13px Mulish,sans-serif;color: #3f3f46">Local-first: l'edge resta tuo</span><span style="height: 14px;width: 1px;background: rgba(24,24,27,.12)"></span>
    <span style="font: 600 13px Mulish,sans-serif;color: #3f3f46">Costruiamo in pubblico</span>
  </div>
</section>

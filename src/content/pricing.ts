...
<header data-nav="" style="position: fixed;top: 0;left: 0;right: 0;z-index: 50;transition: transform .3s ease,box-shadow .3s ease,background .3s ease;background: rgba(255,255,255,.8);backdrop-filter: blur(12px);-webkit-backdrop-filter: blur(12px)">
  <div style="max-width: 1152px;margin: 0 auto;display: flex;align-items: center;gap: 12px;padding: 0 32px;height: 60px">
    ...
    <nav data-nav-links="" style="display: flex;align-items: center;gap: 26px;margin-left: 34px;font-size: 13.5px;font-weight: 600;color: #52525b">
      ...
      <a href="/pricing" style="color: #18181b">Pricing</a>
...
<!-- ============ PRICING HERO ============ -->
<section id="top" style="max-width: 1152px;margin: 0 auto;padding: 128px 32px 8px;text-align: center">
  <div data-reveal="" style="opacity: 0;transform: translateY(28px);transition: opacity .7s cubic-bezier(.16,1,.3,1),transform .7s cubic-bezier(.16,1,.3,1)">
    <span style="display: inline-flex;align-items: center;gap: 6px;border-radius: 999px;padding: 5px 12px;font: 600 11.5px/1 'IBM Plex Mono',monospace;letter-spacing: .12em;text-transform: uppercase;white-space: nowrap;background: #EEEDFB;color: #5B57D9">PRICING</span>
    <h1 style="font-family: 'Space Grotesk',sans-serif;font-weight: 700;font-size: 44px;line-height: 1.08;letter-spacing: -.02em;margin: 18px 0 0;color: #18181b">Il primo anno è <span style="background: linear-gradient(100deg,#18181b,#5B57D9);-webkit-background-clip: text;background-clip: text;color: transparent">gratis.</span></h1>
    <p style="color: #6b7280;font-size: 16px;line-height: 1.6;margin: 16px auto 0;max-width: 560px">Poi paghi la capacità che ti diamo — mai una percentuale su quanto guadagni. Siamo software: il tuo P&amp;L non ci riguarda.</p>
    <div data-reveal="" data-reveal-d="80" style="display: inline-flex;align-items: center;gap: 10px;margin-top: 22px;padding: 12px 18px;border-radius: 14px;background: #fff;border: 1px solid rgba(24,24,27,.08);box-shadow: 0 1px 2px rgba(24,24,27,.04),0 12px 30px -20px rgba(24,24,27,.2);opacity: 0;transform: translateY(28px);transition: opacity .7s cubic-bezier(.16,1,.3,1),transform .7s cubic-bezier(.16,1,.3,1)">
      <span style="display: grid;place-items: center;height: 28px;width: 28px;border-radius: 999px;background: #16a34a;color: #fff;flex: none"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-4-4"></path></svg></span>
      <p style="margin: 0;font-size: 13.5px;color: #3f3f46;text-align: left"><b style="color: #18181b">Early adopter:</b> chi entra in beta ha 12 mesi interamente gratuiti su qualsiasi tier — e blocca il prezzo al rinnovo.</p>
    </div>
  </div>
</section>
<!-- ============ TIERS ============ -->
<section style="max-width: 1152px;margin: 0 auto;padding: 36px 32px 10px">
  <div data-mscroll="" style="display: grid;grid-template-columns: repeat(4,1fr);gap: 16px;align-items: stretch">
    ...
    <div data-reveal="" data-reveal-d="0" style="position: relative;display: flex;flex-direction: column;background: #fff;border: 1px solid rgba(24,24,27,.07);border-radius: 20px;box-shadow: 0 1px 2px rgba(24,24,27,.04),0 12px 32px -20px rgba(24,24,27,.16);padding: 26px;opacity: 0;transform: translateY(28px);transition: opacity .7s cubic-bezier(.16,1,.3,1),transform .7s cubic-bezier(.16,1,.3,1)">
      ...
      <div style="display: flex;align-items: center;justify-content: space-between;gap: 8px"><span style="font-family: 'Space Grotesk',sans-serif;font-weight: 700;font-size: 17px;color: #18181b">Free</span></div>
      <p style="margin: 16px 0 0;font-family: 'Space Grotesk',sans-serif;font-weight: 700;font-size: 38px;line-height: 1;color: #18181b">€0<span style="font-size: 14px;font-weight: 600;color: #6b7280"> / per sempre</span></p>
      <p style="margin: 8px 0 0;font: 500 11.5px 'IBM Plex Mono',monospace;color: #a1a1aa">la porta d’ingresso, local-first</p>
    ...
    <div data-reveal="" data-reveal-d="80" style="position: relative;display: flex;flex-direction: column;background: #fff;border: 1px solid rgba(24,24,27,.07);border-radius: 20px;box-shadow: 0 1px 2px rgba(24,24,27,.04),0 12px 32px -20px rgba(24,24,27,.16);padding: 26px;opacity: 0;transform: translateY(28px);transition: opacity .7s cubic-bezier(.16,1,.3,1),transform .7s cubic-bezier(.16,1,.3,1)">
      
      <div style="display: flex;align-items: center;justify-content: space-between;gap: 8px"><span style="font-family: 'Space Grotesk',sans-serif;font-weight: 700;font-size: 17px;color: #18181b">Pro</span><span style="display: inline-flex;padding: 4px 9px;border-radius: 999px;background: #f0fdf4;border: 1px solid rgba(22,163,74,.3);font: 700 10px 'IBM Plex Mono',monospace;letter-spacing: .08em;text-transform: uppercase;color: #16a34a;white-space: nowrap">1° anno €0</span></div>
...
<!-- ============ LINEE ROSSE ============ -->
<section style="max-width: 1152px;margin: 0 auto;padding: 36px 32px 40px">
  <div data-reveal="" style="position: relative;overflow: hidden;border-radius: 22px;background: #131316;border: 1px solid rgba(255,255,255,.08);padding: 32px 34px;box-shadow: 0 26px 60px -30px rgba(0,0,0,.55);opacity: 0;transform: translateY(28px);transition: opacity .7s cubic-bezier(.16,1,.3,1),transform .7s cubic-bezier(.16,1,.3,1)">
    <div style="position: absolute;inset: 0;background-image: linear-gradient(rgba(150,180,190,.07) 1px,transparent 1px),linear-gradient(90deg,rgba(150,180,190,.07) 1px,transparent 1px);background-size: 32px 32px;pointer-events: none"></div>
    <div style="position: relative;display: grid;grid-template-columns: .9fr 1.4fr;gap: 30px;align-items: center" data-r="split">
      <div>
        <h3 style="font-family: 'Space Grotesk',sans-serif;font-weight: 700;font-size: 24px;line-height: 1.15;margin: 0;color: #fff">Le nostre linee rosse</h3>
        <p style="color: #a1a1aa;font-size: 13.5px;line-height: 1.6;margin: 12px 0 0">Sono ciò che rende il modello pulito — e il motivo per cui puoi fidarti dei nostri incentivi.</p>
      </div>
      <div style="display: flex;flex-direction: column;gap: 12px">
        <div style="display: flex;gap: 11px;align-items: flex-start"><span style="display: grid;place-items: center;height: 22px;width: 22px;border-radius: 999px;flex: none;background: rgba(255,255,255,.1);color: #fff;margin-top: 1px"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-4-4"></path></svg></span><p style="margin: 0;color: #d4d4d8;font-size: 14px;line-height: 1.55"><b style="color: #fff">Mai una fee sui profitti dei clienti,</b> a nessuna condizione e con nessuna modalità d'incasso.</p></div>
        <div style="display: flex;gap: 11px;align-items: flex-start"><span style="display: grid;place-items: center;height: 22px;width: 22px;border-radius: 999px;flex: none;background: rgba(255,255,255,.1);color: #fff;margin-top: 1px"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-4-4"></path></svg></span><p style="margin: 0;color: #d4d4d8;font-size: 14px;line-height: 1.55"><b style="color: #fff">Il marketplace vende codice,</b> mai segnali con esecuzione automatica.</p></div>
        <div style="display: flex;gap: 11px;align-items: flex-start"><span style="display: grid;place-items: center;height: 22px;width: 22px;border-radius: 999px;flex: none;background: rgba(255,255,255,.1);color: #fff;margin-top: 1px"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-4-4"></path></svg></span><p style="margin: 0;color: #d4d4d8;font-size: 14px;line-height: 1.55"><b style="color: #fff">Copy trading solo sotto licenza di un partner vigilato.</b> L'unica performance fee che incassiamo è sulle <b style="color: #fff">nostre</b> strategie, sotto ombrello regolamentato.</p></div>
      </div>
    </div>
  </div>
</section>
